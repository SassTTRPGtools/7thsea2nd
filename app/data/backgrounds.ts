...
export const backgrounds: Record<string, Background> = {
  ...
  archaeologist: {
    ...
    quirk: '當你將一件有價值的遺物交給大學、博物館或公開展示的場所時,獲得一點英雄點。',
  ...
  aristocrat: {
    ...
    quirk: '當你證明貴族的價值不僅止於華服與禮儀時,獲得一點英雄點。',
  ...
  armyOfficer: {
    ...
    quirk: '當你在極端暴力或危險時刻奪取指揮權時,獲得一點英雄點。',
  ...
  artist: {
    ...
    quirk: '當你為了讓瑟亞大陸變得更美而犧牲某些東西時,獲得一點英雄點。',
  ...
  assassin: {
    ...
    quirk: '當你主動避免殺害對手,或拒絕可能導致他人死亡的行動時,獲得一點英雄點。',
  ...
  crafter: {
    ...
    quirk: '當你以日常工藝技術解決他人認為過於複雜的問題時,獲得一點英雄點。',
  ...
  doctor: {
    ...
    quirk: '當你治療了惡徒或被惡徒傷害的無辜者時,獲得一點英雄點。',
  ...
  duelist: {
    ...
    quirk: '當你為了守護崇高信念而拔劍戰鬥時,獲得一點英雄點。',
  ...
  engineer: {
    ...
    quirk: '當你以技術知識與巧思成功解決難題時,獲得一點英雄點。',
  ...
  explorer: {
    ...
    name: '探險家',
    nameEn: 'Explorer',
    description: '你生於冒險,追求見證泰拉(Terra)最遙遠的疆界。',
    quirk: '當你親眼目睹鮮少瑟亞大陸人曾見之景象時,獲得一點英雄點。',
  ...
  farmkid: {
    ...
    quirk: '當你以簡單、實用的農村方法解決複雜問題時,獲得一點英雄點。',
  ...
  hunter: {
    ...
    quirk: '當你運用獵人本能救人於危險之中時,獲得一點英雄點。',
  ...
  mercenary: {
    ...
    quirk: '當你因信念或情感,而非金錢利益而出手時,獲得一點英雄點。',
  ...
  merchant: {
    ...
    quirk: '當你以低於市價的價格,將物品賣給迫切需要之人時,獲得一點英雄點。',
  ...
  navalOfficer: {
    ...
    quirk: '當你將船員的安全置於任務目標之上時,獲得一點英雄點。',
  ...
  orphan: {
    ...
    quirk: '當你冒險涉險,只為不讓他人孤單受苦時,獲得一點英雄點。',
  ...
  performer: {
    ...
    quirk: '當你運用取悅群眾的技巧,為超越金錢的目的而行動時,獲得一點英雄點。',
  ...
  pirate: {
    ...
    quirk: '當你為他人的自由而作出個人犧牲時,獲得一點英雄點。',
  ...
  priest: {
    ...
    quirk: '當你放下言辭,身體力行你所宣揚的美德時,獲得一點英雄點。',
  ...
  professor: {
    ...
    quirk: '當你運用冷門文獻中的知識成功解決難題時,獲得一點英雄點。',
  ...
  pugilist: {
    ...
    quirk: '當你放下武器,選擇徒手迎戰,無論對手持何種武器時,獲得一點英雄點。',
  ...
  sailor: {
    ...
    quirk: '當你為了同伴的安全與舒適而放下個人慾望時,獲得一點英雄點。',
  ...
  scholar: {
    ...
    name: '學者',
    nameEn: 'Scholar',
    description: '你獻身於知識的追求,致力記錄泰拉(Terra)的奇觀。',
    quirk: '當你為了獲得知識而身陷險境時,獲得一點英雄點。',
  ...
  servant: {
    ...
    quirk: '當你為了協助他人完成困難任務而使自己陷入危險時,獲得一點英雄點。',
  ...
  soldier: {
    ...
    quirk: '當你堅守既定計畫,即便因此身陷危險時,獲得一點英雄點。',
  ...
  bard: {
    ...
    quirk: '當你依循傳奇的榜樣行事而解決問題時,獲得一點英雄點。',
  ...
  puritan: {
    ...
    quirk: '當你揭露教宗教會中的腐敗、偽善或無能時,獲得一點英雄點。',
  ...
  saoi: {
    ...
    description: '你擁有奧斯達納(Aosdána)所授予的最高榮譽,身為受國家支持的創作者與藝術守護者。',
    quirk: '當你為了保護瑟亞大陸的藝術家而身陷險境時,獲得一點英雄點。',
  ...
  diestro: {
    ...
    quirk: '當你在決鬥中擊敗受過正式訓練的劍士時,獲得一點英雄點。',
  ...
  mirabilis: {
    ...
    quirk: '當你以身作則展現教宗教會的慈悲與溫暖時,獲得一點英雄點。',
  ...
  hexe: {
    ...
    name: '赫森術師',
    nameEn: 'Hexe',
    description: '你精通赫森術(Hexenwerk),那是與亡者相關的黑暗巫術。',
    quirk: '當你特意確保死者不再復起時,獲得一點英雄點。',
  ...
  krieger: {
    ...
    quirk: '當你挺身戰鬥以保護弱者或防止破壞時,獲得一點英雄點。',
  ...
  ungetumjager: {
    ...
    quirk: '當你追獵異形生物,使其永不再害人時,獲得一點英雄點。',
  ...
  sorcierPorte: {
    ...
    description: '你精通「傳門術(Porté)」——開啟空間之門的魔法。',
    quirk: '當你關閉被惡徒撕裂開的傷痕(Blessure)時,獲得一點英雄點。',
  ...
  posel: {
    ...
    quirk: '當你在投票對你不利時仍堅持民主原則,獲得一點英雄點。',
  ...
  tremtis: {
    ...
    description: '在「貴族民主制(Golden Liberty)」建立後,你逃往聯邦尋求庇護。',
    quirk: '當你被過去的陰影追上時,獲得一點英雄點。',
  ...
  wingedHussar: {
    ...
    quirk: '當你與坐騎無懼危險、率先衝入戰場時,獲得一點英雄點。',
  ...
  cossack: {
    ...
    quirk: '當你放棄重要之物、輕裝前行以利旅途時,獲得一點英雄點。',
  ...
  progressivist: {
    ...
    quirk: '當你冒著生命危險去獲取先進技術時,獲得一點英雄點。',
  ...
  touchedByMatushka: {
    ...
    quirk: '當你以一種能讓瑪圖什卡自豪的方式教導他人時,獲得一點英雄點。',
  ...
  whaler: {
    ...
    quirk: '當你面對能吞噬整個人類的巨大生物時,獲得一點英雄點。',
  ...
  bearsark: {
    ...
    quirk: '當你讓遊戲主持人決定你角色的下一個行動時,獲得一點英雄點。',
  ...
  guildmastaren: {
    ...
    quirk: '當你將商聯龐大資源用於比利益更高尚的目的時,獲得一點英雄點。',
  ...
  sjorover: {
    ...
    quirk: '當你為了在眾神之父(Allfather)之席贏得榮耀而身陷險境時,獲得一點英雄點。',
  ...
  skald: {
    ...
    quirk: '當你以符文詠者(Seidr)的智慧協助他人解決問題或阻止惡徒時,獲得一點英雄點。',
  ...
  bravo: {
    ...
    quirk: '當你為了保護所守護之人的性命而身陷危險時,獲得一點英雄點。',
  ...
  consigliere: {
    ...
    name: '顧問',
    nameEn: 'Consigliere',
    description: '你擔任貿易親王(Merchant Prince)的「顧問」,專司處理機密與謀略。',
    quirk: '當你為了保守他人祕密而冒極大風險時,獲得一點英雄點。',
  ...
  esploratore: {
    ...
    quirk: '當你運用非瑟亞世界的物品或知識解決問題時,獲得一點英雄點。',
  ...
  sorteStrega: {
    ...
    quirk: '當你選擇一條危險的道路,因相信那是命運的安排時,獲得一點英雄點。',
    advantages: ['sorcery', 'sorcery', 'timeSense'],
